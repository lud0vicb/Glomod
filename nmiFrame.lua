...
function nmiFrameOnload(self)
  ...
  self.emote1:SetNormalTexture("Interface\\ICONS\\Ability_Warrior_BattleShout")
  ...
  self.emote2:SetPushedTexture("Interface\\ICONS\\Achievement_WorldEvent_Brewmaster")
  ...
  self.emote3:SetPushedTexture("Interface\\ICONS\\INV_Gauntlets_40")
  self.emote3:SetHighlightTexture("Interface\\Buttons\\LegendaryOrange64","MOD")
  self.emote4 = createButton(self, 150, -54, emote4, "")
  self.emote4:SetNormalTexture("Interface\\ICONS\\INV_Holiday_BrewfestBuff_01")
  self.emote4:SetPushedTexture("Interface\\ICONS\\INV_Holiday_BrewfestBuff_01")
  ...
  self.emote5:SetPushedTexture("Interface\\ICONS\\INV_Misc_Bomb_04")
  ...
  self.emote6:SetPushedTexture("Interface\\ICONS\\Spell_Priest_Pontifex")
  ...
  self.emote7:SetPushedTexture("Interface\\ICONS\\Spell_Priest_VowofUnity")
  ...
  self.emote8:SetPushedTexture("Interface\\ICONS\\Ability_DemonHunter_EyeBeam")
